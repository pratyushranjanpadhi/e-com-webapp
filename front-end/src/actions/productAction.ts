...
const listProductDetails = (id: any) => async (dispatch: any) => {
   try {
...
const deleteProduct = (id: any) => async (dispatch: any, getState: any) => {
   try {
...
const createProduct = () => async (dispatch: any, getState: any) => {
   try {
...
const updateProduct = (product: any) => async (dispatch: any, getState: any) => {
   try {
...
const listTopRatedProducts = () => async (dispatch: any) => {
   try {
